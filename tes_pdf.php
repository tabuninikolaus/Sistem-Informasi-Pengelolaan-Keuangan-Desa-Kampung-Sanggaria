...
<!-- Hero Section -->
<section class="relative h-[65vh] bg-cover bg-center" style="background-image: url('../assets/img/sanggaria.jpeg');">
  <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-black/20 flex items-center justify-center">
    <div class="text-center text-white px-4">
      <h1 class="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg">Sistem Informasi Keuangan Desa</h1>
      <p class="text-lg max-w-2xl mx-auto drop-shadow">Transparansi, Akuntabilitas, dan Partisipasi Masyarakat Kampung Sanggaria.</p>
    </div>
  </div>
</section>
...
<section class="py-20 px-6 md:px-16 bg-gray-100 max-w-7xl mx-auto">
  ...
  <div class="grid md:grid-cols-2 gap-6 text-center">
    ...
    ?>
    <a href="<?= $url ?>" target="_blank" class="bg-white p-6 shadow rounded-xl hover:shadow-lg transition">
    ...
    <table class="w-full border text-sm bg-white shadow">
      ...
      <tbody>
        ...
        <tr class="hover:bg-gray-50">
          ...
          <td class="border px-4 py-2 text-center font-semibold text-primary"><?= $row['realisasi_persen'] ?>%</td>
        </tr>
        <?php endwhile; ?>
      </tbody>
    </table>
